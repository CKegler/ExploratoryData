...
# @author Colin Kegler
# 
# plot3.R defines one method, plot3, which generates a plot of Global Active Power vs time (the 2 day period)
...
plot3 <- function() {
    ...
    legend('topright', names(extract)[4,5,6] , legendLines , col=c("black", "red", "blue"),lty=1)
